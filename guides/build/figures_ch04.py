...
ax.text(5.0,3.85,'Climb down the abstraction ladder until the claim is checkable',ha='center',fontsize=11.5,color=GREEN,weight='bold')
rungs=[('“improved performance”  ·  abstract — believe me',2.85,'#F1E9E7',INK),
       ('“faster support responses”  ·  directional — trust me',1.75,'#DFE9E2',INK),
       ('“cut response time 9 hrs → 2.1 hrs in the 90-day pilot”  ·  concrete — CHECK me',0.65,GREEN,'white')]
for t,y,fc,tc in rungs:
    box(ax,0.5,y,9.0,0.85,t,fc=fc,tc=tc,fs=10.5)
...
for j,(t,sub) in enumerate(rout):
    ...
    ax.text(0.3+j*2.45+1.1,1.8,sub,ha='center',va='top',fontsize=9.3,color=INK)
